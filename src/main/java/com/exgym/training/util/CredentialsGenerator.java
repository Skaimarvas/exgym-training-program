...
public class CredentialsGenerator {
    ...
    public static String generateUsername(String firstName, String lastName, Map<Long, ? extends User> existingUsers) {
    ...
    private static boolean usernameExists(String username, Map<Long, ? extends User> existingUsers) {
