...
public interface TrainingDao extends JpaRepository<Training, Long> {
	...
	java.util.List<Training> findTraineeTrainings(String traineeUserName, java.util.Date fromDate, java.util.Date toDate, String trainerName, com.exgym.training.enums.TrainingType trainingType);
	...
	java.util.List<Training> findTrainerTrainings(String trainerUserName, java.util.Date fromDate, java.util.Date toDate, String traineeName);
}
